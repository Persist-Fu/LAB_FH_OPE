...
{
public:
    int type;                    //用来区分 InternalNode 和 LeafNode
    int parent_index;            //记录当前节点是父节点的第几个孩子
    Node *parent = NULL;
    virtual void rebalance() {};
    virtual long long insert(int pos, string cipher) { return 0; };
    virtual long long search(int pos) { return 0; };  //查找 pos 对应的 code
};
...
public:
    ...
    void insert_node(int index, Node *new_node);//插入新的 Node
};
